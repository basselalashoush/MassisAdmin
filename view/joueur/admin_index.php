<div class="table_title">
    <p>Welcome To The Administrator Airea</p>
</div>
<?php $page_title = 'list joueurs'; ?>
...
<table id="myTable" class=" table table-striped snipe-table"
        ...
        <thead>   
            <tr>
                ...
                <th data-sortable="true"  data-visible="true">action</th>
            </tr>
        </thead>
        <tbody>
            <?php
            foreach ($lesJoueur as $unjoueur) : ?>
                <tr>
                    ...
                    <td><?= $unjoueur->mute?></td>
                    <td><a href="<?=BASE_URL.DS.'cockpit/joueur'.DS.'edit'.DS.$unjoueur->id_joueur?>">Editer</a>
                        <a onclick = "return confirm('Voulez vous vraiment supprimer ce contenu')" href=" <?php echo Router::url("joueur/view/id:{$unjoueur->id_joueur}");?>">Supprimer</a>
                    </td>
                    <?php endforeach ; ?>
            </tr>
        </tbody>      
