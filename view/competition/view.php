...
<table class="calander">
  <tr><td colspan="7" align="center"><a href="<?= BASE_URL.DS.'competition'.DS.'view'.'?mois='.($num_mois-1).'&annee='. $num_an ?>"><i class="fas fa-angle-double-left"></i></a>&nbsp;&nbsp;<?php echo $tab_mois[$num_mois];  ?>&nbsp;&nbsp;<a href="<?= BASE_URL.DS.'competition'.DS.'view'.'?mois='.($num_mois+1).'&annee='. $num_an ?>"><i class="fas fa-angle-double-right"></i></a></td></tr>
  <tr><td colspan="7" align="center"><a href="<?= BASE_URL.DS.'competition'.DS.'view'.'?mois='.$num_mois.'&annee='. ($num_an-1) ?>"><i class="fas fa-angle-double-left"></i></a>&nbsp;&nbsp;<?php echo $num_an; ;  ?>&nbsp;&nbsp;<a href="<?= BASE_URL.DS.'competition'.DS.'view'.'?mois='.$num_mois.'&annee='. ($num_an+1) ?>"><i class="fas fa-angle-double-right"></i></a></td></tr>
  <?php
  echo'<tr>';
  for($i = 1; $i <= 7; $i++){
